		...
		<div class="container-fluid">
			...
			<div class="col-sm-7" class="pad">
				<div class="pad">
					...
					<form action="//VegWorcester.us2.list-manage.com/subscribe/post?u=38963ea1aa7f978ae2c06864a&amp;id=f8c8808133" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
...
<div id="contact" class="modal fade in">
            ...
            <div class="modal-body">
              ...
              <h3>Connect with VegFest</h3>
							<div class="ctas">
								<a class="cta" href="//www.facebook.com/NewEnglandVegFest" target="_blank"><i class="fa fa-facebook-square"></i> LIKE US</a>
